...
| LLM | gpt-4o-mini INR 0.1021 (1 min) - 0.2411 (10 min); gemini-2.5-flash INR 0.2310 (1 min) - 0.5100 (10 min); gemini-2.5-flash-lite INR 0.0685 (1 min) - 0.1618 (10 min); gpt-4.1-mini INR 0.2734 (1 min) - 0.6457 (10 min); gpt-5.4-mini INR 0.5421 (1 min) - 1.2390 (10 min) on Azure OpenAI eastus2 (D-410, where an Azure resource, key and deployment are configured); INR 0.00 on the Sarvam 105B fallback (D-36). Which model runs is `azure_openai_model`, a live switch | _not measured_ | — |
