...
*Applied 20 Aug 2026, merged with two sibling lanes' gate-8 additions: the caller-observed
latency delta (`docs/evidence/bolna-call-flows.md` §9) and the tool-timeout absence plus the
`%(execution_id)s` question (`docs/evidence/bolna-tools-integrations.md` §7).*
