...
function quota(over: Partial<AiQuota> = {}): AiQuota {
  return {
    ...
    // with the model three times — 200/116 at ₹0.50, 133/77 at ₹0.75 — and a fixture no
    // server can answer with is a wrong number carrying a fixture's authority.
    requests_included: 416,
    requests_remaining: 242,
...
describe("the allowance panel", () => {
  it("shows both units, with the count labelled as an estimate", async () => {
    ...
    expect(screen.getByText(/of about 416 this month/)).toBeTruthy();
