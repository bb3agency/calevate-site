 ...
 * 6. **CLOSING IS NOT REACHABLE FROM HERE AT ALL (D-545)**, which is the assertion that
...
describe("the account state screen", () => {
  ...
  it("offers no state control on a closed account, and points at the one that reopens it", async () => {
    ...
    // NOT "cannot be reopened", which is what this said before D-545 and was true of this
  ...
  it("cannot close an account at all — there is one door and it is not this one", async () => {
    /**
     * THE D-545 COLLAPSE, pinned. Two ways to end a client relationship existed and the
