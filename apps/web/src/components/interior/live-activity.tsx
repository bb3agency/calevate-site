        ...
        {activity ? (
          <motion.div
            ...
            style={{
              ...
              // Cap the rendered width to the viewport so the expanded pod never
              // overflows a narrow screen. `width` (the prop) is preserved as the
          ...
          >
            ...
            >
              ...
              {percent !== null && phase === "running" ? (
                ...
                <span className="max-w-[120px] truncate text-[12px] font-medium text-ink">
                  {activity.title}
                </span>
              )}
            </motion.div>
            ...
            >
              ...
              {activity.detail ? (
                <p className="mt-1 truncate pl-[26px] text-[11.5px] text-ink-muted">
                  {activity.detail}
                </p>
              ) : null}
                ...
                <div className="mt-2.5 flex items-center gap-2 pl-[26px]">
                  <div className="min-w-0 flex-1 rounded-[4px] bg-ink/[0.06] p-[2px] shadow-[inset_0_1px_2px_rgba(28,25,23,0.1)] dark:shadow-[inset_0_1px_2px_rgba(0,0,0,0.45)]">
                    <div className="relative h-[4px] overflow-hidden rounded-[2px]">
                      <motion.span
                        aria-hidden
                        className="absolute inset-0 block origin-left rounded-[2px] bg-brand shadow-[inset_0_1px_0_rgba(255,255,255,0.35)] dark:bg-brand-bright"
                        initial={false}
...
function PhaseGlyph({ phase, reduced }: { phase: ActivityPhase; reduced: boolean }) {
  return (
    <span className="grid size-[18px] shrink-0 place-items-center">
      ...
      >
        {reduced ? (
          <svg width="13" height="13" viewBox="0 0 12 12" aria-hidden>
            <circle cx="6" cy="6" r="4.4" stroke="currentColor" strokeWidth="1.6" fill="none" className="text-ink-faint" opacity="0.4" />
          </svg>
        ) : (
          <motion.svg
            width="13"
            ...
            animate={{ rotate: 360 }}
            transition={SPIN}
            className="text-brand dark:text-brand-bright"
          >
      ...
      <motion.span
        className="col-start-1 row-start-1 flex text-brand"
        initial={false}
        animate={{
