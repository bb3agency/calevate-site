  ...
  return (
    <>
      <motion.button
        ...
        className={`relative inline-flex h-9 touch:h-11 select-none items-center justify-center rounded-[9px] border border-line bg-surface px-3.5 text-[13px] font-medium text-ink shadow-[inset_0_1.5px_0_rgba(255,255,255,0.95),inset_0_-1px_0_rgba(28,25,23,0.06),0_1px_2px_rgba(28,25,23,0.08)] outline-none transition-[border-color,box-shadow,background-color] duration-150 hover:bg-ink/[0.04] focus-visible:border-brand focus-visible:shadow-[0_1px_2px_rgba(28,25,23,0.08),0_10px_20px_-14px_rgba(22,160,93,0.6)] disabled:opacity-50 dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.07),0_1px_2px_rgba(0,0,0,0.4)] dark:focus-visible:border-brand-bright dark:focus-visible:shadow-[0_10px_20px_-14px_rgba(34,197,94,0.5)] ${className}`}
