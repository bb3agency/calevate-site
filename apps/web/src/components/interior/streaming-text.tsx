...
export function StreamingText({
  ...
  const caret = (
    ...
    >
      <motion.span
        className="absolute inset-y-0 left-px block w-[2px] bg-ink"
        initial={false}
      ...
      {showSkip ? (
        <div className="mt-2.5 flex justify-end">
          <button
            ...
            className="inline-grid h-7 touch:h-9 place-items-center rounded-[6px] border border-line px-2.5 text-[11.5px] font-medium text-ink-muted transition-colors duration-150 hover:text-ink focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand"
          >
            <motion.span
              aria-hidden
