...
function Caret({ open }: { open: boolean }) {
  ...
  return (
    <motion.span
      ...
      className="flex size-4 shrink-0 items-center justify-center text-ink-faint"
    >
...
export function TreeView({
      ...
      return (
        <li key={node.id} role="none">
          <div
            ...
            className={`flex h-7 cursor-default select-none items-center gap-1 rounded-[8px] px-1.5 outline-none transition-colors duration-150 focus-visible:bg-brand/[0.06] focus-visible:shadow-[inset_0_0_0_1px_#16a05d] dark:focus-visible:bg-brand-bright/[0.1] dark:focus-visible:shadow-[inset_0_0_0_1px_#22c55e] ${
              isSelected
          ...
          {row.branch ? (
            <AnimatePresence initial={false}>
              {row.open ? (
                ...
                >
                  <div className="ml-[13px] border-l border-line pl-[7px]">
  ...
  return (
    <div
      className={`rounded-[13px] border border-line bg-surface p-[5px] shadow-[0_1px_2px_rgba(28,25,23,0.06),0_4px_10px_-8px_rgba(28,25,23,0.45)] dark:shadow-[0_1px_6px_rgba(0,0,0,0.45)] ${className}`}
    >
