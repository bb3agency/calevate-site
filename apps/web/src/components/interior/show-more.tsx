...
export function ShowMore({
  ...
  return (
    <div
      className={`text-[13.5px] leading-relaxed text-ink ${className}`}
    >
      <div className="relative">
        <motion.div
          ...
          className="overflow-hidden overscroll-contain rounded-[6px] outline-none focus-visible:bg-brand/[0.06] focus-visible:shadow-[inset_0_0_0_1px_#16a05d] dark:focus-visible:bg-brand-bright/[0.10] dark:focus-visible:shadow-[inset_0_0_0_1px_#22c55e]"
        >
        ...
        <motion.div
          ...
          className="pointer-events-none absolute inset-x-0 bottom-0 h-9 bg-gradient-to-t from-surface to-surface/0"
        />
      </div>
      <div className="mt-2 flex h-8 touch:h-11 items-center">
        <button
          type="button"
          onClick={press}
          aria-expanded={open}
