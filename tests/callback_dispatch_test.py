...
**THIS IS THE TEST THAT WOULD FAIL IF SOMEBODY BUILT A PARALLEL DIAL PATH** (D-510), and
...
last clause is not hypothetical: cross-call memory (D-509) is injected inside
