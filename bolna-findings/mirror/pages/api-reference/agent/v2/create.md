...
| `reasoning_effort '<value>' is not supported for model '<model>'` | Use an effort the model accepts — see the [per-model table](/docs/providers/llm-model/openai#reasoning-effort)                        |
...
paths:
  /v2/agent:
    post:
      ...
      responses:
        '201':
          description: agent created response
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/AgentCreateStatus'
        '400':
