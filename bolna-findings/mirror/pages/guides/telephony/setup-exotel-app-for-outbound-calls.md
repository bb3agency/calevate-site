...
<Frame caption="Exotel App Bazaar location in dashboard">
  <img src="https://mintcdn.com/bolna-54a2d4fe/HwOYKfzp4mnvdMa0/images/setup_exotel_app_for_outbound_calls_step_1.png?fit=max&auto=format&n=HwOYKfzp4mnvdMa0&q=85&s=2b961531d75b2e3a6de08d51eea605e1" alt="Exotel dashboard highlighting the App Bazaar menu option under Manage section for creating Bolna Voice AI outbound calling applications" width="3136" height="1568" data-path="images/setup_exotel_app_for_outbound_calls_step_1.png" />
</Frame>
...
<Frame caption="Creating a new Exotel app for Bolna integration">
  <img src="https://mintcdn.com/bolna-54a2d4fe/HwOYKfzp4mnvdMa0/images/setup_exotel_app_for_outbound_calls_step_2.png?fit=max&auto=format&n=HwOYKfzp4mnvdMa0&q=85&s=19277f5eed84249739afc3bc529f48c6" alt="Exotel app creation interface showing name input field where users configure Bolna AI outbound calling application settings" width="3136" height="1568" data-path="images/setup_exotel_app_for_outbound_calls_step_2.png" />
</Frame>
...
<Frame caption="Adding Voicebot component to Exotel workflows">
  <img src="https://mintcdn.com/bolna-54a2d4fe/HwOYKfzp4mnvdMa0/images/setup_exotel_app_for_outbound_calls_step_3.png?fit=max&auto=format&n=HwOYKfzp4mnvdMa0&q=85&s=177650e1cb854ee44717402d3959b950" alt="Exotel workflow builder showing Voicebot component being dragged into the app canvas to enable Bolna AI voice agent functionality" width="3136" height="1568" data-path="images/setup_exotel_app_for_outbound_calls_step_3.png" />
</Frame>
...
<Frame caption="Voicebot configuration panel - Setting up Bolna API endpoint and call recording options for AI voice interactions">
  <img src="https://mintcdn.com/bolna-54a2d4fe/HwOYKfzp4mnvdMa0/images/setup_exotel_app_for_outbound_calls_step_4.png?fit=max&auto=format&n=HwOYKfzp4mnvdMa0&q=85&s=719f2566745d65074d5eee57a6de43a2" alt="Exotel Voicebot settings showing Bolna API callback URL configuration for outbound AI calling setup" width="2506" height="1253" data-path="images/setup_exotel_app_for_outbound_calls_step_4.png" />
</Frame>
...
<Frame caption="Connect component configuration for call transfers">
  <img src="https://mintcdn.com/bolna-54a2d4fe/HwOYKfzp4mnvdMa0/images/setup_exotel_app_for_outbound_calls_step_5.png?fit=max&auto=format&n=HwOYKfzp4mnvdMa0&q=85&s=2bf1fb8a8e7b1d0fb0adfa64a3d4e979" alt="Exotel Connect app settings showing dynamic URL configuration for Bolna call transfer functionality and call routing setup" width="3136" height="1568" data-path="images/setup_exotel_app_for_outbound_calls_step_5.png" />
</Frame>
...
<Frame caption="Saving and completing the Bolna Voice AI outbound calling integration setup">
  <img src="https://mintcdn.com/bolna-54a2d4fe/HwOYKfzp4mnvdMa0/images/setup_exotel_app_for_outbound_calls_step_6.png?fit=max&auto=format&n=HwOYKfzp4mnvdMa0&q=85&s=706d39c2db66ce01ba71e1e5c9637995" alt="Exotel app configuration complete with Save button highlighted, showing final step of Bolna AI voice agent outbound calling setup" width="3136" height="1568" data-path="images/setup_exotel_app_for_outbound_calls_step_6.png" />
</Frame>
