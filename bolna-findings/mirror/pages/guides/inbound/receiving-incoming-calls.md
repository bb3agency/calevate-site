...
<Note>You will need to assign a phone number to your Bolna Voice AI agent for automatically answering all incoming calls on that phone number</Note>
...
<Steps>
  <Step title="Click &#x22;Assign inbound agent&#x22; button">
    <Frame caption="Click 'Assign inbound agent' button to map a Bolna Voice AI agent to a phone number">
      <img src="https://mintcdn.com/bolna-54a2d4fe/DqJpudnR0YtgOS49/images/receiving_incoming_calls_step_1.png?fit=max&auto=format&n=DqJpudnR0YtgOS49&q=85&s=f2df303e93a227ddfa584ba8e4d2bfa3" alt="Assign inbound agent button in Bolna dashboard for mapping Voice AI agents to phone numbers for incoming call handling" width="1462" height="1004" data-path="images/receiving_incoming_calls_step_1.png" />
    </Frame>
  </Step>

  <Step title="Choose phone number which you want to assign to the Bolna Voice AI agent">
    <Frame caption="Select phone number for Bolna Voice AI agent">
      <img src="https://mintcdn.com/bolna-54a2d4fe/DqJpudnR0YtgOS49/images/receiving_incoming_calls_step_2.png?fit=max&auto=format&n=DqJpudnR0YtgOS49&q=85&s=8962dd022db42a247b7e098a5170118b" alt="Phone number selection interface in Bolna showing available numbers for Voice AI agent assignment and inbound call routing" width="1462" height="1004" data-path="images/receiving_incoming_calls_step_2.png" />
    </Frame>
  </Step>

  <Step title="Confirm the phone number">
    <Frame caption="Setting up the agent">
      <img src="https://mintcdn.com/bolna-54a2d4fe/DqJpudnR0YtgOS49/images/receiving_incoming_calls_step_3.png?fit=max&auto=format&n=DqJpudnR0YtgOS49&q=85&s=bf96eb95a6410a33b5af92445bb681d7" alt="Phone number confirmation screen in Bolna showing agent setup process for inbound Voice AI call handling" width="1462" height="1004" data-path="images/receiving_incoming_calls_step_3.png" />
    </Frame>
  </Step>

  <Step title="Voila! All set.">
    <Frame caption="Your phone numbers is now successfully set up to answers calls by Bolna Voice AI agent">
      <img src="https://mintcdn.com/bolna-54a2d4fe/DqJpudnR0YtgOS49/images/receiving_incoming_calls_step_4.png?fit=max&auto=format&n=DqJpudnR0YtgOS49&q=85&s=e4edb1e9900f74abe75e4c716b129012" alt="Successful phone number assignment confirmation in Bolna showing completed Voice AI agent setup for answering incoming calls" width="1462" height="1004" data-path="images/receiving_incoming_calls_step_4.png" />
    </Frame>
  </Step>
</Steps>
